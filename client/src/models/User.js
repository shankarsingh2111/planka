...
export default class extends BaseModel {
  ...
  static fields = {
    ...
    showExtraBoardViews: attr(),
    showQuarterTimelineZoom: attr(),
    timelineZoomLevel: attr(),
    timelineGroupBy: attr(),
    timelineColorBy: attr(),
    timelineSidebarOpened: attr(),
    timelineBoardPreferences: attr(),
    isDefaultAdmin: attr(),
    isSsoUser: attr(),
    isDeactivated: attr(),
