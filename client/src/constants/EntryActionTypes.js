...
export default {
  ...
  CARD_DEPENDENCIES_IN_CURRENT_BOARD_FETCH: `${PREFIX}/CARD_DEPENDENCIES_IN_CURRENT_BOARD_FETCH`,
  ...
  CARD_WITH_DETAILS_CREATE: `${PREFIX}/CARD_WITH_DETAILS_CREATE`,
  ...
  CARD_SCHEDULE: `${PREFIX}/CARD_SCHEDULE`,
