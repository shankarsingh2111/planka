...
export default {
  ...
  translation: {
    common: {
      ...
      closed: 'Closed',
      color: 'Color',
      colorByLabel: 'Color by label',
      colorByList: 'Color by list',
      colorByMember: 'Color by member',
      colorByProject: 'Color by project',
      ...
      thisWeek: 'This week',
      timelineViewHint: 'Cards on a date axis — drag bars to reschedule and link dependencies.',
      ...
      doubleClickToAddCard: 'Double-click an empty spot in a lane to add a card there.',
      ...
      noCardsWithDates:
        'No cards with dates. Set a start date or due date on cards to see them on the timeline.',
      noConnectionToServer: 'No connection to server',
      noData: 'No data',
      noLabels: 'No Labels',
      noLists: 'No lists',
      noProjects: 'No projects',
      noUnscheduledCards: 'No unscheduled cards',
      ...
      unscheduledCards: '{{count}} unscheduled',
      unscheduledCardsSidebar: 'Unscheduled cards',
      ...
      workload: 'Workload',
      workloadLegendHint: 'Open cards per member per week (by start and due dates).',
